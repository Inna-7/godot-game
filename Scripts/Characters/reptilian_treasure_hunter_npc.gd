...
func interact():
	if not is_interacting:
		...
		Globals.hud.set_speaker_image("res://Images/reptilian/reptilian_still_image_front.png")
		
		if not Globals.player.sync_completed_quests.has("Find Glenn"):
			Globals.hud.set_dialog_text("You have to be tough if you want to survive in this place. Glenn huh? He's often getting himself into trouble. I don't know where he is though.")
		else:
			Globals.hud.set_dialog_text("You have to be tough if you want to survive in this place.")
