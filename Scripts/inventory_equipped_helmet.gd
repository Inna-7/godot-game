...
func _unequip_helmet():
	...
	if Globals.player.sync_equipped_helmet.name != "Helmet":
		Globals.player.add_item_to_inventory(Globals.player.sync_equipped_helmet.name,Globals.player.sync_equipped_helmet.item_health,Globals.player.sync_equipped_weapon.rarity)
