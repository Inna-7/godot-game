...
const adventure_area_2_background_music = preload("res://Music/Level_2_Adv_Area.ogg")
...
func _on_body_entered(body):
	...
	Globals.hud.set_local_area('Scrune Wastes')
	get_tree().root.get_node("Game").get_node("MusicPlayer").stream = adventure_area_2_background_music
