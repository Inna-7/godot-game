...
const adventure_area_8_background_music = preload("res://Music/Level_8_Adv_Area.wav")
...
func _on_body_entered(body):
	...
	get_tree().root.get_node("Game").get_node("MusicPlayer").stream = adventure_area_8_background_music
