...
const adventure_area_6_background_music = preload("res://Music/Level_6_Adv_Area.wav")
...
func _on_body_entered(body):
	...
	Globals.hud.set_local_area('Adv Area 6')
	get_tree().root.get_node("Game").get_node("MusicPlayer").stream = adventure_area_6_background_music
