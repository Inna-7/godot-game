...
@export var _trilium_reward_min : float = 0.005
@export var _trilium_reward_max : float = 0.01
...
@export var _rare_drops : Array[String] = [
	"res://Scenes/Items/common_dagger.tscn",
	"res://Scenes/Items/common_sword.tscn",
	"res://Scenes/Items/common_shovel.tscn",
	"res://Scenes/Items/common_armor.tscn",
	"res://Scenes/Items/common_helmet.tscn",
