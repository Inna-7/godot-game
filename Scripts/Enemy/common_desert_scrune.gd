...
@export var _starting_hit_points_min : int  = 40
@export var _starting_hit_points_max : int = 60
@export var _experience_reward_points : int = 3
...
@export var _rare_drops : Array[String] = [
	"res://Scenes/Items/epic_dagger.tscn",
	"res://Scenes/Items/epic_sword.tscn",
	"res://Scenes/Items/epic_shovel.tscn",
	"res://Scenes/Items/epic_armor.tscn",
	"res://Scenes/Items/epic_helmet.tscn",
