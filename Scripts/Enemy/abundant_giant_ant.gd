...
@export var _starting_hit_points_min : int  = 10
@export var _starting_hit_points_max : int = 30
@export var _experience_reward_points : int = 1
@export var _trilium_reward_min : float = 0.001
@export var _trilium_reward_max : float = 0.005
...
@export var _rare_drops : Array[String] = [
	"res://Scenes/Items/abundant_dagger.tscn",
	"res://Scenes/Items/abundant_sword.tscn",
	"res://Scenes/Items/abundant_shovel.tscn",
	"res://Scenes/Items/abundant_armor.tscn",
	"res://Scenes/Items/abundant_helmet.tscn",
	"res://Scenes/Items/copper_ore.tscn",
	"res://Scenes/Items/iron_ore.tscn",
	"res://Scenes/Items/silver_ore.tscn",
	"res://Scenes/Items/gold_ore.tscn"
]
