...
@export var _starting_hit_points_min : int  = 90
@export var _starting_hit_points_max : int = 120
@export var _experience_reward_points : int = 20
@export var _trilium_reward_min : float = 0.5
@export var _trilium_reward_max : float = 0.75
...
@export var _rare_drops : Array[String] = [
	"res://Scenes/Items/mythical_dagger.tscn",
	"res://Scenes/Items/mythical_sword.tscn",
	"res://Scenes/Items/mythical_shovel.tscn",
	"res://Scenes/Items/mythical_armor.tscn",
	"res://Scenes/Items/mythical_helmet.tscn",
]
