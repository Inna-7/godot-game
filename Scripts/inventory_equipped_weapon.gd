...
func _unequip_weapon():
	...
	if Globals.player.sync_equipped_weapon.item_health < 100:
		pass
			
	print(Globals.player.sync_equipped_weapon.name)
		
	if Globals.player.sync_equipped_weapon.name != "Left Hand":
		Globals.player.add_item_to_inventory(Globals.player.sync_equipped_weapon.name,Globals.player.sync_equipped_weapon.item_health,Globals.player.sync_equipped_weapon.rarity)
		Globals.player.save_equipped_weapon({"equippedWeapon": "Left Hand","equippedWeaponHealth":100})
