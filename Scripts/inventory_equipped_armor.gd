...
func _unequip_armor():
	...
	if Globals.player.sync_equipped_armor.name != "Armor":
		Globals.player.add_item_to_inventory(Globals.player.sync_equipped_armor.name,Globals.player.sync_equipped_armor.item_health,Globals.player.sync_equipped_weapon.rarity)
